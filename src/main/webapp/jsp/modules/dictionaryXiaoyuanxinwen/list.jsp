    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">校园新闻类型管理</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">校园新闻类型列表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">校园新闻类型列表</h3>
...
<script>
    ...
    function getDataList() {
        http("dictionary/page", "GET", {
            ...
            order: sortOrder,
            //本表的
            dicCode: "xiaoyuanxinwen_types",//编码名字
            dicName: "校园新闻类型名称",//汉字名字
