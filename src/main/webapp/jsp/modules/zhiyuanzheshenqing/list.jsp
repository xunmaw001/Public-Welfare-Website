...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">志愿者申请管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">志愿者申请列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">志愿者申请列表</h3>
    ...
    <script>
        ...
        function getDataList() {
            http("zhiyuanzheshenqing/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,
                order: sortOrder,
        ...
        function setDataRow(item, number) {
            ...
            row.appendChild(roleTypesCell);
                ...
                //申请内容
            var zhiyuanzheshenqingContentCell = document.createElement('td');
            //如果图文详情包含图片
            if (item.zhiyuanzheshenqingContent && item.zhiyuanzheshenqingContent.indexOf('img') != -1) {
                //暂时只考虑图片+文字 和 文字+图片的情况
                var beginIndex = item.zhiyuanzheshenqingContent.indexOf('<img');
                var endIndex = item.zhiyuanzheshenqingContent.indexOf('>');
                    zhiyuanzheshenqingContentCell.innerHTML = item.zhiyuanzheshenqingContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
            } else {
                if (item.zhiyuanzheshenqingContent != null && item.zhiyuanzheshenqingContent != "" && item.zhiyuanzheshenqingContent.length >= 11) {
                        zhiyuanzheshenqingContentCell.innerHTML = item.zhiyuanzheshenqingContent.substring(0, 10) + "...";
                } else {
                        zhiyuanzheshenqingContentCell.innerHTML = item.zhiyuanzheshenqingContent;
                }
            }
            row.appendChild(zhiyuanzheshenqingContentCell);


                //申请材料
            var zhiyuanzheshenqingFileCell = document.createElement('td');
            if(item.zhiyuanzheshenqingFile ==null || item.zhiyuanzheshenqingFile == '' || item.zhiyuanzheshenqingFile == 'null'){
                    zhiyuanzheshenqingFileCell.innerHTML = '没有下载文件';
            }else {
                var zhiyuanzheshenqingFileFile = document.createElement('button');
                    zhiyuanzheshenqingFileFile.innerHTML = '下载';
                var zhiyuanzheshenqingFileFileAttr = "download('" + item.zhiyuanzheshenqingFile + "')"
                    zhiyuanzheshenqingFileFile.setAttribute('onclick',zhiyuanzheshenqingFileFileAttr);
                    zhiyuanzheshenqingFileCell.appendChild(zhiyuanzheshenqingFileFile);
            }
            row.appendChild(zhiyuanzheshenqingFileCell);
            ...
            //是否同意
            var zhiyuanzheshenqingYesnoTypesCell = document.createElement('td');
            zhiyuanzheshenqingYesnoTypesCell.innerHTML = item.zhiyuanzheshenqingYesnoValue;
            row.appendChild(zhiyuanzheshenqingYesnoTypesCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("zhiyuanzheshenqing/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addzhiyuanzheshenqing", "addzhiyuanzheshenqing");
            window.location.href = "add-or-update.jsp"
        }
