...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">物品捐赠管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">物品捐赠列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">物品捐赠列表</h3>
                            <div class="table-responsive mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        取件地址
                                        <div class="layui-input-inline">
                                            <input type="text" id="qujianAddressSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="取件地址" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //取件地址
            var qujianAddressSearchInput = $('#qujianAddressSearch');
            if( qujianAddressSearchInput != null){
                if (qujianAddressSearchInput.val() != null && qujianAddressSearchInput.val() != '') {
                    searchForm.qujianAddress = $('#qujianAddressSearch').val();
                }
            }
                            getDataList();
        }
        ...
        function getDataList() {
            http("juanzeng/page", "GET", {
                ...
                qujianAddress: searchForm.qujianAddress,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //取件地址
            var qujianAddressCell = document.createElement('td');
            qujianAddressCell.innerHTML = item.qujianAddress;
            row.appendChild(qujianAddressCell);


                //捐赠详情
            var juanzengContentCell = document.createElement('td');
            //如果图文详情包含图片
            if (item.juanzengContent && item.juanzengContent.indexOf('img') != -1) {
                //暂时只考虑图片+文字 和 文字+图片的情况
                var beginIndex = item.juanzengContent.indexOf('<img');
                var endIndex = item.juanzengContent.indexOf('>');
                    juanzengContentCell.innerHTML = item.juanzengContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
            } else {
                if (item.juanzengContent != null && item.juanzengContent != "" && item.juanzengContent.length >= 11) {
                        juanzengContentCell.innerHTML = item.juanzengContent.substring(0, 10) + "...";
                } else {
                        juanzengContentCell.innerHTML = item.juanzengContent;
                }
            }
            row.appendChild(juanzengContentCell);


            //是否接收
            var juanzengTypesCell = document.createElement('td');
            juanzengTypesCell.innerHTML = item.juanzengValue;
            row.appendChild(juanzengTypesCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("juanzeng/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addjuanzeng", "addjuanzeng");
            window.location.href = "add-or-update.jsp"
        }
