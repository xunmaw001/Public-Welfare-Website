            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑公益活动收藏</li>
                    </ol>
                </div>
            </div>
        </div>
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("gongyihuodongCollection/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
    ...
    // 获取当前详情
    function getDetails() {
        var addgongyihuodongCollection = window.sessionStorage.getItem("addgongyihuodongCollection");
        if (addgongyihuodongCollection != null && addgongyihuodongCollection != "" && addgongyihuodongCollection != "null") {
            //注册表单验证
            $(validform());
            $('#submitBtn').text('新增');
            ...
            window.sessionStorage.removeItem('updateId');
            http("gongyihuodongCollection/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
