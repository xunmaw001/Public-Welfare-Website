            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">志愿者申请展示</span>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 zhiyuanzheshenqingContent 字段去除无用字符 如果字段长度大于60  就截取到60
            zhiyuanzheshenqingContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery', 'laydate'], function() {
        ...
        function pageList() {
            ...
            // 当前表
                                                                    // 获取列表数据
            http.request('zhiyuanzheshenqing/list', 'get', param, function(res) {
    ...
    // 当前表的字典表
       ...
       function zhiyuanzheshenqingYesnoTypesSelect() {
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=zhiyuanzheshenqing_yesno_types", 'get', {}, function (res) {
               if(res.code == 0){
