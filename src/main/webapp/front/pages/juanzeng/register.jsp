              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">物品名字:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="wupinName" id="wupinName"  placeholder="物品名字"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">物品类型:</span>
                        <div class="layui-input-inline">
                            <select name="wupinTypes" id="wupinTypes" lay-filter="wupinTypes" style="width: 600px;">
                ...
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">物品数量:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="wupinNumber" id="wupinNumber"  lay-verify="integer|required"   placeholder="物品数量" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">取件地址:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="qujianAddress" id="qujianAddress"  placeholder="取件地址"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <select name="juanzengTypes" id="juanzengTypes" lay-filter="juanzengTypes" style="width: 600px;">
