            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">物品捐赠展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="wupinName" id="wupinName" placeholder="物品名字" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="qujianAddress" id="qujianAddress" placeholder="取件地址" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 juanzengContent 字段去除无用字符 如果字段长度大于60  就截取到60
            juanzengContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery', 'laydate'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#qujianAddress').val() != null && jquery('#qujianAddress').val() != "" && jquery('#qujianAddress').val() != "null" ) {
                param['qujianAddress'] = jquery('#qujianAddress').val();
            }
                                            // 获取列表数据
            http.request('juanzeng/list', 'get', param, function(res) {
    ...
    // 当前表的字典表
       ...
       function juanzengTypesSelect() {
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=juanzeng_types", 'get', {}, function (res) {
               if(res.code == 0){
