        ...
        <form class="layui-form layui-form-pane" lay-filter="myForm">
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-block">
                    <input v-model="detail.wupinName" type="text" name="wupinName" id="wupinName" placeholder="物品名字" lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-block">
                    <input v-model="detail.qujianAddress" type="text" name="qujianAddress" id="qujianAddress" placeholder="取件地址" lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            ...
            <%--<div class="layui-form-item" pane>--%>
                ...
                <%--<div class="layui-input-block">--%>
                    <%--<select name="juanzengTypes" id="juanzengTypes" lay-filter="juanzengTypes">--%>
    ...
    layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate', 'tinymce'], function () {
       ...
       juanzengTypesSelect();
        ...
        form.on('submit(thisSubmit)', function (data) {
            ...
            // 提交数据
            http.requestJson('juanzeng' + '/add', 'post', data, function (res) {
                layer.msg('提交成功', {
                    time: 2000,
                    icon: 6
                }, function () {
