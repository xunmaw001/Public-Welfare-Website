              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">民生新闻名称:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="minshengxinwenName" id="minshengxinwenName"  placeholder="民生新闻名称"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">民生新闻类型:</span>
                        <div class="layui-input-inline">
                            <select name="minshengxinwenTypes" id="minshengxinwenTypes" lay-filter="minshengxinwenTypes" style="width: 600px;">
