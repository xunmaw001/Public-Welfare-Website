            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">公益活动展示</span>
                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../gongyihuodong/detail.jsp?id='+item.id)">
                                ...
                                <div class="ng-prslist-tit" @click="jump('../gongyihuodong/detail.jsp?id='+item.id)"><span>{{item.gongyihuodongName}}</span></div>
...
<script>
    var vue = new Vue({
        ...
        data: {
            ...
            dataList: [],//数据
        // 当前表字典表数据
            gongyihuodongTypesList : [],
            gongyihuodongTypes: 1,//类型
            limit: 10,
        ...
        filters: {
            //把 gongyihuodongContent 字段去除无用字符 如果字段长度大于60  就截取到60
            gongyihuodongContent: function(val) {
                if (val) {
        ...
        function pageList() {
            ...
            if (jquery('#canyuTime').val() != null && jquery('#canyuTime').val() != "" && jquery('#canyuTime').val() != "null" ) {
                param['canyuTime'] = jquery('#canyuTime').val();
                            ...
                            // 获取列表数据
            http.request('gongyihuodong/list', 'get', param, function(res) {
