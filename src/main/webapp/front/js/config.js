...
var centerMenu = [
    ...
    ,{
        name: '公益活动收藏',
        url: '../gongyihuodongCollection/list.jsp'
    }
    ,{
        name: '公益活动预约',
        url: '../gongyihuodongOrder/list.jsp'
    }
...
var indexNav = [
    ...
    {
        name: '公益活动',
        url: './pages/gongyihuodong/list.jsp'
    },
    {
        name: '物品捐赠',
        url: './pages/juanzeng/add.jsp'
    },
    {
        name: '民生新闻',
        url: './pages/minshengxinwen/list.jsp'
    },
    {
        name: '校园新闻',
        url: './pages/xiaoyuanxinwen/list.jsp'
    },

]

var adminurl =  "http://localhost:8080/gongyiwangzhan/index.jsp";
