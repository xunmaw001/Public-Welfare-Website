...
public class GongyihuodongOrderEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public GongyihuodongOrderEntity() {

	}

	public GongyihuodongOrderEntity(T t) {
		try {
    ...
    public String toString() {
        return "GongyihuodongOrder{" +
            "id=" + id +
            ", gongyihuodongId=" + gongyihuodongId +
            ", yonghuId=" + yonghuId +
            ", gongyihuodongOrderTypes=" + gongyihuodongOrderTypes +
