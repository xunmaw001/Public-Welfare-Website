 ...
 */
@TableName("gongyihuodong_collection")
public class GongyihuodongCollectionView extends GongyihuodongCollectionEntity implements Serializable {
	...
	public GongyihuodongCollectionView() {

	}

	public GongyihuodongCollectionView(GongyihuodongCollectionEntity gongyihuodongCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, gongyihuodongCollectionEntity);
